...
class Transaction extends \Google\Protobuf\Internal\Message
{
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>.transaction.v1.TransactionType transaction_type = 2 [json_name = "transactionType"];</code>
     */
    protected $transaction_type = 0;
    /**
     * Generated from protobuf field <code>.transaction.v1.Platform platform = 3 [json_name = "platform"];</code>
     */
    protected $platform = 0;
    /**
     * Generated from protobuf field <code>.types.v1.Address address = 4 [json_name = "address"];</code>
     */
    protected $address = null;
    /**
     * Generated from protobuf field <code>string account_id = 5 [json_name = "accountId"];</code>
     */
    protected $account_id = '';
    /**
     * Generated from protobuf field <code>.transaction.v1.PaymentMethod payment_method = 6 [json_name = "paymentMethod"];</code>
     */
    protected $payment_method = 0;
    /**
     * Generated from protobuf field <code>.types.v1.Money price = 7 [json_name = "price"];</code>
     */
    protected $price = null;
    /**
     * Generated from protobuf field <code>.types.v1.ShippingMethod shipping_method = 8 [json_name = "shippingMethod"];</code>
     */
    protected $shipping_method = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp created_at = 9 [json_name = "createdAt"];</code>
     */
    protected $created_at = null;
    /**
     * Generated from protobuf field <code>.transaction.v1.ItemType item_type = 10 [json_name = "itemType"];</code>
     */
